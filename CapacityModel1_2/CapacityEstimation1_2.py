...
class TrainTestSplit:
    def __init__(self, feature_path, save_path, soh_Path):
        ...
        sohFiles = [item for item in os.listdir(self.sohPath) if item.endswith('_svm.csv')]
    ...
    def splitDataset(self):
        ...
        def split(group):
            ...
            SOHs = list(set(group['SOH'].values))
...
savePath = r'E:\pycharm\DigitalCarRace\CapacityModel1_2_2'
